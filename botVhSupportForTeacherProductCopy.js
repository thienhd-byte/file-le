...
const allowedBroadcastSenderIds = new Set(['151333233', 151333233, 1230651720, "1230651720", "1912632528", 1912632528, "2033518516", 2033518516]);
...
async function executeBroadcast(msg, photoFileIds) {
    ...
    const groupSupportVh = '-4130384459';
        ...
        try {
            ...
            if (threadId) {
                ...
                try {
                    ...
                    console.error('Lỗi gửi thông báo vào thread support:', threadError, userProfile.teleChatId, threadId);
                }
            } else {
