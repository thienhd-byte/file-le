...
// recordAttribute: timestamp || senderId || groupCode || messageHtml || mediaType || totalSent || totalFailed || broadcastId || chainId || parentBroadcastId || broadcastTitle || messageType
const fileLogBroadcastHistory = new HActiveRecordFile({
    fileName: 'log_broadcast_history',
    recordAttribute: ['timestamp', 'senderId', 'groupCode', 'messageHtml', 'mediaType', 'totalSent', 'totalFailed', 'broadcastId', 'chainId', 'parentBroadcastId', 'broadcastTitle', 'messageType', 'isSurvey', 'surveyOptions'],
