    ...
    bot.on("callback_query", async (callbackQuery) => {
        ...
        if (data === "dktele") {
            ...
            await bot.sendMessage(callbackQuery.message.chat.id, reportText, {
                parse_mode: 'HTML',
                reply_markup: {
                    inline_keyboard: [[{ text: 'Gửi nhắc nhở', callback_data: `send_reminder_${broadcastId}` }]]
                }
            });
        }
    ...
    bot.on("message", async (msg) => {
        ...
        if (msg.text === '/send-msg-module' && allowedBroadcastSenderIds.has(msg.from.id.toString())) {
            ...
            if (broadcasts.length === 0) {
                await bot.sendMessage(msg.chat.id, 'Không có broadcast nào.');
                return;
            }
            ...
            await bot.sendMessage(msg.chat.id, 'Chọn broadcast để xem báo cáo:', {
